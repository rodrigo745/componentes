    ...
    return (
        <div>
            <div className="contenedor-card-btn shadow-md flex flex-col items-end">
                <Link
                    href="/pages/buttons/documentacion#asd"
                    className="absolute text-sm mx-3 mt-3 border border-gray-300 text-gray-400 px-3 rounded-md shadow-sm hover:border-gray-500 hover:text-black"
                >
                    Ver
                </Link>
                <div className="flex justify-center content-center h-full w-full">
                    <button
                        id="1"
                        className={`transition delay-150 duration-300 ease-in-out ${props.estilo} ${color} m-auto`}
                    >
                ...
                {bandera.map((e, index) => (
                    <button
                        ...
                        className={`${opcionBase} ${
                            coloresArray != undefined && coloresArray[index]
                        }`}
                    ></button>
                ))}
            </div>
