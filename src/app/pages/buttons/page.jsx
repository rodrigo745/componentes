        ...
        <div className="p-10 xl:px-20 mt-24 md:mt-0">
            ...
            <div className='border flex justify-center shadow-inner rounded-lg mt-6 py-10'>
                <div className="cuadriculaBtn grid grid-cols-1 md:grid-cols-2 xl:grid-cols-2 gap-10 2xl:gap-16 2xl:grid-cols-3 gap-y-10">
                     {
                        estilosBtn[0].simples.map((e, index)=>
                         (   
            ...
            <div className='border flex justify-center shadow-inner rounded-lg mt-6 py-10'>
                <div className="cuadriculaBtn grid grid-cols-1 md:grid-cols-2 xl:grid-cols-2 gap-10 2xl:gap-16 2xl:grid-cols-3 gap-y-10">
                    ...
                    {
                        estilosBtn[0].compuestos.map((e, index)=>
                         (   
            ...
            <div className='border flex justify-center shadow-inner rounded-lg mt-6 py-10'>
                <div className="cuadriculaBtn grid grid-cols-1 md:grid-cols-2 xl:grid-cols-2 gap-10 2xl:gap-16 2xl:grid-cols-3 gap-y-10">
                    {
                        estilosBtn[0].variados.map((e, index)=>
                         (   
                                <Btn_1 key={index} base={e.base} estilo={e.estilo} ejemplos={e.ejemplos} colores={e.colores} spin={e.spin} texto={e.texto}/>
                        )
                        )
...
// PONER ESTO EN LA DOCUMENTACION
const estilosBtn = [
    {
        "simples": [
            {
...
const otro = {
    "compuestos": [
        ...
        "bg-transparent text-red-300 border border-red-300 px-5 py-1 hover:bg-red-300 hover:text-white rounded-md shadow-md",
        "bg-transparent text-red-300 border border-red-300 px-5 py-1 hover:bg-red-300 hover:text-white",
        "bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 px-4 py-1 text-white rounded-md"
    ]
}